/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2747a194ee4e4eb3761c36943f4ef73c)
// Runtime types generated with workerd@1.20250924.0 2025-01-01 
declare namespace Cloudflare {
	...
	interface Env {
		KV: KVNamespace;
		VECTORIZE_INDEX: "ppoi-embeddings-dev" | "ppoi-embeddings";
		EMBEDDING_MODEL: "@cf/baai/bge-base-en-v1.5";
		IMAGE_MODEL_FAST: "@cf/black-forest-labs/flux-1-schnell";
		IMAGE_MODEL_QUALITY: "@cf/black-forest-labs/flux-1-schnell";
		NODE_ENV: string;
		NEXTAUTH_URL: string;
